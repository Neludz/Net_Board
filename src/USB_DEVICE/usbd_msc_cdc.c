...
const USBD_ClassTypeDef  USBD_MSC_CDC_ClassDriver =
{
	USBD_MSC_CDC_Init,
	USBD_MSC_CDC_DeInit,
	USBD_MSC_CDC_Setup,
...
static const uint8_t USBD_MSC_CDC_DeviceQualifierDesc[USB_LEN_DEV_QUALIFIER_DESC] =
{
...
* @retval pointer to descriptor buffer
*/
 uint8_t *USBD_MSC_CDC_DeviceQualifierDescriptor (uint16_t *length)
{
	*length = sizeof (USBD_MSC_CDC_DeviceQualifierDesc);
	return (uint8_t *) USBD_MSC_CDC_DeviceQualifierDesc;
}
